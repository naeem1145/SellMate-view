...
const ItemPage = () => {
  ...
  const getAllItems = async () => {
    try {
      ...
      const { data } = await instance.get("/api/items/get-item");
      setItemsData(data);
  ...
  const handleDelete = async (record) => {
    try {
      ...
      await instance.post("/api/items/delete-item", { itemId: record._id });
  ...
  const handleSubmit = async (value) => {
    if (editItem === null) {
      try {
        ...
        await instance.post("/api/items/add-item", value);
      ...
      try {
        ...
        await instance.put("/api/items/edit-item", {
          ...value,
          itemId: editItem._id,
        });
